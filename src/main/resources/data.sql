...
(99999, 'CALLE VIENA', '06600', 'Col Juarez', 19.429671, -99.157913, '16', '', 273, null),;
...
(4, 'Necesito despensa basica, Necesito despensa basica, Necesito despensa basica, Necesito despensa basica, Necesito despensa basica', 2, 12, 4, 'SOLICITA', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'PENDIENTE'),
...
(13, 'Puedo manejar para llevar personas por la tarde', 2, 1, 3, 'OFRECE', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'NUEVA');

INSERT INTO PETICION (ID, AYUDA_ID, CIUDADANO_ID, AYUDA_MATCH_ID, TIPO_MATCH, FECHA_PETICION) VALUES
(1, 1, 2, null, 'MANUAL', TIMESTAMP '2020-03-22 00:00:00.000'),
(2, 1, null, 13, 'AUTOMATIC', TIMESTAMP '2020-03-30 00:00:00.000');

INSERT INTO OFERTA (ID, NOMBRE, DESCRIPCION, CIUDADANO_ID, GEO_LOCATION_ID, RANGO_PRECIO, FECHA_REGISTRO, ACTIVE, ESTATUS_OFERTA) VALUES
(1, 'Bicicleta Electrica', 'Hace falta cambiar la batería', 1, 99999, 'ENTRE_400_899', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'NUEVA'),
(2, 'Jitomate ataulfo', 'Reja de 40 kilos', 2, 2, 'ENTRE_1_399', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'PENDIENTE'),
(3, 'Microondas MABE', 'Tiene 3 meses de uso y está en perfectas condiciones.', 1, 11, 'MAS_DE_2000', TIMESTAMP '2020-03-20 00:00:00.000', 1, 'NUEVA');
